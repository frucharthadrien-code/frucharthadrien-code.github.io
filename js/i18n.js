...
(function () {
  ...
  const T = {
    fr: {
      ...
      "index.strip.title": "Deux chantiers qui montrent le craft",
      ...
      "works.title": "Travaux",
      "works.lead": "Deux études de cas réelles — migration WordPress et application Flutter. Pas de fausses vitrines.",
      ...
      "fe.gallery.note": "Captures bureau complètes — haut et bas recadrés (chrome navigateur et barre des tâches masqués).",
    ...
    en: {
      ...
      "index.strip.title": "Two projects that show the craft",
      "index.w1.title": "Fruchart Équilibre",
      ...
      "works.title": "Work",
      "works.lead": "Two real case studies — WordPress migration and Flutter app. No fake portfolios.",
      ...
      "fe.gallery.note": "Full desktop captures — top and bottom cropped (browser chrome and taskbar hidden).",
    ...
    ru: {
      ...
      "index.strip.title": "Два проекта, которые показывают мастерство",
      "index.w1.title": "Fruchart Équilibre",
      ...
      "works.title": "Работы",
      "works.lead": "Два реальных кейса — миграция WordPress и Flutter-приложение. Без фальшивых витрин.",
      ...
      "fe.gallery.note": "Полные захваты экрана ПК — верх и низ обрезаны (скрыты браузер и панель задач).",
