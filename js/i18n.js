...
(function () {
  ...
  const T = {
    fr: {
      ...
      "meta.contact.desc": "Me contacter pour un projet web ou mobile.",
      ...
      "contact.lead": "Un projet web, une migration ou une app mobile ? Écrivez-moi.",
      ...
      "hh.story": "L'idée m'a été donnée par un ami — Houriez. Il m'a parlé d'une horloge qui ne ressemblerait à aucune autre : une spirale à la place du cadran rond, des étoiles aux points cardinaux, des billes le long des orbites, une signature « Trophy Lights ». J'ai pris ce brief visuel et l'ai transformé en application bureau qui tourne vraiment — le même objet poétique, mais vivant sur l'écran.",
      "hh.h2.what": "Ce que c'est (en clair)",
      "hh.p1": "Une <strong>horloge de bureau Windows</strong> livrée en exécutable autonome (<code>HorlogeHouriez.exe</code>). Le cadran reprend un design organique : spirale, étoiles dorées aux points cardinaux, billes chromées le long des orbites, signature <strong>TROPHY LIGHTS BY HOURIEZ</strong>.",
      ...
      "hh.p3": "Ce n'est pas Flutter : l'app est compilée avec <strong>Tauri 2</strong> (Rust + WebView2). Le cadran est rendu en HTML/CSS/JS dans une WebView embarquée ; l'heure vient de l'API <code>Date</code> JavaScript, calée sur l'horloge système Windows — même principe qu'une horloge de bureau classique, mais avec ce design spiralé.",
    ...
    en: {
      ...
      "meta.contact.desc": "Get in touch for a web or mobile project.",
      ...
      "contact.title": "Contact",
      "contact.lead": "A web project, migration or mobile app? Drop me a line.",
      "contact.email": "frucharthadrien@gmail.com",
      ...
      "hh.story": "The idea came from a friend — Houriez. He described a clock unlike any other: a spiral instead of a round dial, stars at the cardinal points, spheres along the orbits, a « Trophy Lights » signature. I took that visual brief and turned it into a desktop app that actually runs — the same poetic object, alive on screen.",
      "hh.h2.what": "What it is (in plain words)",
      "hh.p1": "A <strong>Windows desktop clock</strong> shipped as a standalone executable (<code>HorlogeHouriez.exe</code>). The dial uses an organic design: spiral, golden stars at the cardinal points, chrome spheres along the orbits, signature <strong>TROPHY LIGHTS BY HOURIEZ</strong>.",
      ...
      "hh.p3": "This is not Flutter: the app is built with <strong>Tauri 2</strong> (Rust + WebView2). The dial is rendered in HTML/CSS/JS inside an embedded WebView; time comes from JavaScript's <code>Date</code> API, tied to the Windows system clock — same principle as a classic desktop clock, with this spiral design.",
    ...
    ru: {
      ...
      "meta.contact.desc": "Связаться по веб- или мобильному проекту.",
      ...
      "contact.lead": "Проект, миграция или приложение? Напишите.",
      "contact.email": "frucharthadrien@gmail.com",
      ...
      "hh.story": "Идею подал друг — Houriez. Он рассказал про часы не как у всех: спираль вместо круглого циферблата, звёзды по сторонам света, шары на орбитах, подпись « Trophy Lights ». Я взял этот визуальный бриф и сделал из него настольное приложение, которое реально идёт — тот же поэтичный объект, но живой на экране.",
      "hh.h2.what": "Что это (простыми словами)",
      "hh.p1": "<strong>Настольные часы Windows</strong> в виде автономного exe (<code>HorlogeHouriez.exe</code>). Циферблат со спиралью, золотыми звёздами по сторонам света, хромированными шарами на орбитах, подпись <strong>TROPHY LIGHTS BY HOURIEZ</strong>.",
      ...
      "hh.p3": "Это не Flutter: приложение собрано на <strong>Tauri 2</strong> (Rust + WebView2). Циферблат — HTML/CSS/JS во встроенной WebView; время из API <code>Date</code> JavaScript, привязано к системным часам Windows.",
