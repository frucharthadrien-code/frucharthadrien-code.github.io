...
(function () {
  ...
  const T = {
    ...
    ru: {
      ...
      "hh.story": "В 1959 году Christian Hourriez — ученик École Boulle — выиграл конкурс RTF с оригинальным циферблатом: часы на спирали, «улитка». С 1959 по 1974 год она шла в эфире ORTF как эталон: зрители сверяли часы перед телевизором. Часовщик выпустил домашнюю версию — знаменитые Trophy. Друг предложил оживить её на экране; я сделал настольное приложение, верное духу оригинала.",
