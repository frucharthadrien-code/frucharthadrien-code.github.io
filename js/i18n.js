...
(function () {
  ...
  const T = {
    fr: {
      ...
      "index.sit.c1.desc": "Quitter Wix ou refaire un site qui ne convient plus — WordPress propre, contenu repris, mise en ligne.",
      ...
      "index.sit.c3.desc": "App Flutter livrée end-to-end. Android uniquement — pas d'App Store iOS pour l'instant.",
      "index.sit.c4.title": "Petit logiciel Windows",
      "index.sit.c4.desc": "Outil bureau simple (type horloge, utilitaire). Scope limité — pas de logiciel métier complexe.",
      "index.sit.cta": "En parler →",
      "index.homeCta.title": "Parlons de votre projet",
      "index.homeCta.lead": "Décrivez où vous en êtes — réponse sous 48 h, sans engagement.",
      ...
      "faq.a3": "Oui — migration Wix → WordPress, correction, formulaires, mise en prod (ex. o2switch). Je m'adapte à l'existant ; pas de refonte totale sans l'avoir cadrée ensemble.",
      ...
      "about.p3": "Formé au développement web et mobile, j'ai livré des projets concrets — migration WordPress pour un coach (Fruchart Équilibre), application Flutter (Meet'n'Sing), horloge bureau Windows en Tauri (Horloge Houriez). Chaque dossier part d'un brief réel, avec du code versionné et une mise en prod quand c'est prévu.",
      ...
      "about.p4": "100 % remote. Échanges en français, anglais et russe. Clients en France, Union européenne et russophones à l'international — pas de dépannage PC ni assistance bureautique.",
    ...
    en: {
      ...
      "index.sit.c1.desc": "Leave Wix or rebuild a site that no longer fits — clean WordPress, content carried over, production deploy.",
      ...
      "index.sit.c3.desc": "Flutter app delivered end-to-end. Android only — no iOS App Store for now.",
      "index.sit.c4.title": "Small Windows software",
      "index.sit.c4.desc": "Simple desktop tool (clock, utility). Limited scope — no complex business software.",
      "index.sit.cta": "Discuss →",
      "index.homeCta.title": "Let's talk about your project",
      "index.homeCta.lead": "Tell me where you're at — reply within 48 h, no commitment.",
      ...
      "faq.a3": "Yes — Wix → WordPress migration, fixes, forms, production (e.g. o2switch). I adapt to what exists; no full rebuild without scoping together.",
      "faq.q4": "Do you do IT helpdesk?",
      "faq.a4": "No. I build custom websites and apps — not PC, Word, Outlook or printer support.",
      "faq.q5": "Mobile apps: iOS too?",
      "faq.a5": "Android only for now (Flutter). No iOS App Store publishing.",
      "faq.q6": "How much does it cost?",
      "faq.a6": "It depends on scope. Indicative rates excl. tax: targeted intervention from €350 (half-day), web project (Wix migration, WordPress, forms) from €450 / day — often fixed price. Android app or small Windows exe: on quote, from €500 / day. Free, detailed quote after we discuss your needs — scoped together, no nasty surprises.",
      ...
      "about.p3": "Trained in web and mobile development, I've shipped real projects — a WordPress migration for a coach (Fruchart Équilibre), a Flutter app (Meet'n'Sing), a Windows desktop clock in Tauri (Horloge Houriez). Every job starts from an actual brief, with versioned code and production deploy when agreed.",
      ...
      "about.p4": "100% remote. Communication in French, English and Russian. Clients in France, the EU and Russian-speaking markets internationally — no PC helpdesk or office IT support.",
    ...
    ru: {
      ...
      "index.sit.c3.desc": "Flutter-приложение под ключ. Только Android — без App Store iOS.",
      "index.sit.c4.title": "Небольшая программа Windows",
      "index.sit.c4.desc": "Простой desktop (часы, утилита). Ограниченный scope — не сложное ПО.",
      "index.sit.cta": "Обсудить →",
      "index.homeCta.title": "Обсудим ваш проект",
      "index.homeCta.lead": "Опишите, где вы сейчас — ответ в течение 48 ч, без обязательств.",
      ...
      "faq.a3": "Да — миграция Wix → WordPress, правки, формы, продакшен (напр. o2switch). Адаптируюсь к существующему; полная переделка только после согласования.",
      "faq.q4": "Делаете IT-поддержку?",
      "faq.a4": "Нет. Разрабатываю сайты и приложения на заказ — не поддержку ПК, Word, Outlook или принтера.",
      "faq.q5": "Мобильные приложения: iOS?",
      "faq.a5": "Пока только Android (Flutter). Без публикации в App Store iOS.",
      ...
      "about.h2.path": "Опыт",
      "about.p3": "Обучение веб- и мобильной разработке, реальные проекты — миграция WordPress для коуча (Fruchart Équilibre), Flutter-приложение (Meet'n'Sing), настольные часы Windows на Tauri (Horloge Houriez). Каждый проект — от брифа, с версионированным кодом и деплоем по договорённости.",
      ...
      "about.p4": "100 % remote. Общение на французском, английском и русском. Клиенты во Франции, ЕС и русскоязычные на международном рынке — без IT-поддержки ПК и офисного софта.",
