...
(function () {
  ...
  const T = {
    fr: {
      ...
      "meta.about.desc": "Remote — WordPress, Flutter, migrations. FR / EN / RU. France, UE, international.",
      ...
      "meta.faq.title": "FAQ — Phare numérique",
      "meta.faq.desc": "Questions fréquentes — remote, WordPress, Android, tarifs, délais.",
      ...
      "common.faqLink": "FAQ",
      "common.faqTeaser": "Questions fréquentes →",
      "common.discuss": "Discuter d'un projet",
      "common.backWorks": "← Travaux",

      "index.hero.title": "Développement web & mobile à distance",
      "index.hero.lead": "WordPress sur mesure, migrations propres, apps Flutter, petits logiciels Windows — du brief à la prod, 100 % à distance.",
      ...
      "index.sit.eyebrow": "Interventions",
      "index.sit.title": "Les situations les plus fréquentes",
      "index.sit.c1.title": "Migration ou refonte",
      "index.sit.c1.desc": "Quitter Wix ou repartir sur WordPress propre — contenu repris, mise en ligne.",
      "index.sit.c2.title": "Site WordPress sur mesure",
      "index.sit.c2.desc": "Vitrine, formulaires, évolution technique, mise en prod (o2switch ou autre hébergeur).",
      "index.sit.c3.title": "Application Android",
      "index.sit.c3.desc": "App Flutter livrée end-to-end — Android, livraison APK.",
      "index.sit.c4.title": "Petit logiciel Windows",
      "index.sit.c4.desc": "Outil bureau simple (horloge, utilitaire). Scope ciblé, livrable autonome.",
      "index.sit.cta": "En parler →",
      "index.homeCta.title": "Parlons de votre projet",
      "index.homeCta.lead": "Décrivez où vous en êtes — réponse sous 48 h, devis gratuit.",

      "faq.title": "Questions fréquentes",
      "faq.lead": "Ce qu'on me demande le plus souvent avant de démarrer.",
      "faq.q1": "Comment ça se passe au départ ?",
      "faq.a1": "Vous décrivez votre projet via le formulaire ou par e-mail. Je vous réponds sous 48 h avec des questions de cadrage, puis un devis ou une fourchette selon le périmètre.",
      "faq.q2": "Vous travaillez à distance ?",
      "faq.a2": "Oui, 100 % remote. Échanges par e-mail, visio si besoin. Français, anglais et russe.",
      "faq.q3": "Vous reprenez un site existant ?",
      "faq.a3": "Oui — migration Wix → WordPress, correction, formulaires, mise en prod (ex. o2switch). Je m'adapte à l'existant ; toute refonte est cadrée ensemble avant de démarrer.",
      "faq.q4": "Faites-vous du dépannage informatique ?",
      "faq.a4": "Non. Je développe des sites et des applications sur mesure — pas assistance PC, Word, Outlook ou imprimante.",
      "faq.q5": "Applications mobile : Android ?",
      "faq.a5": "Applications Android avec Flutter — livraison APK, publication Play Store.",
      "faq.q6": "Combien ça coûte ?",
      "faq.a6": "Ça dépend du périmètre. Fourchettes indicatives HT : intervention ponctuelle dès 350 € (demi-journée), chantier web (migration Wix, WordPress, formulaires) dès 450 € / jour — souvent en forfait. App Android ou petit exe Windows : sur devis, dès 500 € / jour. Devis gratuit et précis après échange sur votre besoin — périmètre cadré, devis clair.",

      "works.title": "Travaux",
      "works.lead": "Trois études de cas — migration WordPress, application Flutter, horloge bureau Tauri.",
      ...
      "about.p2": "Je travaille avec des clients qui veulent un interlocuteur technique fiable et du sur mesure.",
      "about.h2.path": "Parcours",
      "about.p3": "Formé au développement web et mobile, je travaille sous Phare numérique. Mes références : refonte WordPress (mon site vitrine coach), application Android Flutter, petit logiciel bureau Windows. Code versionné, livré en prod ; le détail est dans les études de cas.",
      "about.h2.stack": "Stack & livrables",
      "about.stack1": "WordPress sur mesure, Elementor, PHP (mu-plugins, SMTP, Schema.org)",
      "about.stack2": "Migrations Wix → WordPress, formulaires, SEO de base, hébergement (ex. o2switch)",
      "about.stack3": "Applications Android Flutter — interface, logique métier, livraison APK",
      "about.stack4": "Desktop léger Tauri / exe Windows pour petits outils métier",
      "about.stack5": "HTML, CSS, JavaScript — ce portfolio lui-même",
      "about.h2.zone": "Langues & zone",
      "about.p4": "100 % remote. Échanges en français, anglais et russe. Clients en France, Union européenne et russophones à l'international — sites, apps et logiciels bureau.",

      "contact.title": "Parlons de votre projet",
      "contact.lead": "Décrivez où vous en êtes — je réponds sous 48 h.",
      "contact.filter": "Sites WordPress, migrations, applications Android, logiciels bureau Windows — décrivez votre projet.",
      ...
      "contact.trust": "Réponse sous 48 h · devis gratuit · FR / EN / RU",
      "contact.success": "Message envoyé. Je reviens vers vous sous 48 h.",
      "contact.fileWarning": "Pour envoyer le formulaire, ouvrez le site via GitHub Pages ou un serveur local dans Portfolio : python -m http.server 8080 puis http://localhost:8080/contact.html",
      ...
      "contactSent.note": "Je réponds depuis frucharthadrien@gmail.com — ajoutez-le à vos contacts si besoin.",
      ...
      "mns.gallery.title": "Un produit complet",
      ...
      "fe.p1": "Fruchart Équilibre, c'est le site d'un <strong>coach minceur & naturopathe</strong> : méthode RAISON, vidéo explicative, articles, témoignages, tarifs et formulaire d'évaluation. Tout partait de <strong>Wix</strong> — il fallait repartir sur une base saine, avec du code propre à nous.",
      ...
      "fe.li1": "<strong>Migration contenu</strong> — reprise fidèle page par page depuis le live Wix (textes intégraux)",
      ...
      "fe.p3": "Site en ligne chez <strong>o2switch</strong> avec SSL. Les formulaires (évaluation et témoignages) passent par la boîte <strong>contact@fruchartequilibre.com</strong> — envoi SMTP de l'hébergeur, messages reçus en production.",
      ...
      "hh.p2": "<strong>Elle marche.</strong> Les trois aiguilles tournent en continu (heures, minutes, secondes). L'heure affichée est celle de l'horloge système de la machine — l'heure locale exacte de l'utilisateur, <strong>quel que soit son pays</strong>, automatiquement.",
    ...
    en: {
      ...
      "meta.about.desc": "Remote — WordPress, Flutter, migrations. FR / EN / RU. France, EU, international.",
      ...
      "meta.faq.title": "FAQ — Digital Beacon",
      "meta.faq.desc": "FAQ — remote work, WordPress, Android, pricing, timelines.",
      ...
      "common.contactLink": "Contact",
      "common.faqLink": "FAQ",
      "common.faqTeaser": "FAQ →",
      "common.discuss": "Discuss a project",
      "common.backWorks": "← Work",

      "index.hero.title": "Remote web & mobile development",
      "index.hero.lead": "Custom WordPress, clean migrations, Flutter apps, small Windows software — from brief to production, 100% remote.",
      ...
      "index.sit.eyebrow": "Services",
      "index.sit.title": "Most common situations",
      "index.sit.c1.title": "Migration or redesign",
      "index.sit.c1.desc": "Leave Wix or move to clean WordPress — content carried over, production deploy.",
      "index.sit.c2.title": "Custom WordPress site",
      "index.sit.c2.desc": "Showcase site, forms, technical evolution, production (o2switch or other host).",
      "index.sit.c3.title": "Android application",
      "index.sit.c3.desc": "Flutter app delivered end-to-end — Android, APK delivery.",
      "index.sit.c4.title": "Small Windows software",
      "index.sit.c4.desc": "Simple desktop tool (clock, utility). Focused scope, standalone deliverable.",
      "index.sit.cta": "Discuss →",
      "index.homeCta.title": "Let's talk about your project",
      "index.homeCta.lead": "Tell me where you're at — reply within 48 h, free quote.",

      "faq.title": "Frequently asked questions",
      "faq.lead": "What people ask most often before we start.",
      "faq.q1": "How does it start?",
      "faq.a1": "Describe your project via the form or email. I reply within 48 h with scoping questions, then a quote or range depending on scope.",
      "faq.q2": "Do you work remotely?",
      "faq.a2": "Yes, 100% remote. Email, video call if needed. French, English and Russian.",
      "faq.q3": "Can you work on an existing site?",
      "faq.a3": "Yes — Wix → WordPress migration, fixes, forms, production (e.g. o2switch). I adapt to what exists; any full rebuild is scoped together before we start.",
      "faq.q4": "Do you do IT helpdesk?",
      "faq.a4": "No. I build custom websites and apps — not PC, Word, Outlook or printer support.",
      "faq.q5": "Mobile apps: Android?",
      "faq.a5": "Android apps with Flutter — APK delivery, Play Store publishing.",
      "faq.q6": "How much does it cost?",
      "faq.a6": "It depends on scope. Indicative rates excl. tax: targeted intervention from €350 (half-day), web project (Wix migration, WordPress, forms) from €450 / day — often fixed price. Android app or small Windows exe: on quote, from €500 / day. Free, detailed quote after we discuss your needs — scoped together, clear pricing.",

      "works.title": "Work",
      "works.lead": "Three case studies — WordPress migration, Flutter app, Tauri desktop clock.",
      ...
      "about.p2": "I work with clients who want a reliable technical partner and custom work.",
      "about.h2.path": "Background",
      "about.p3": "Trained in web and mobile development, I work as Digital Beacon. My references: WordPress rebuild (my coach showcase site), Flutter Android app, small Windows desktop tool. Versioned code, in production; see the case studies for detail.",
      "about.h2.stack": "Stack & deliverables",
      "about.stack1": "Custom WordPress, Elementor, PHP (mu-plugins, SMTP, Schema.org)",
      "about.stack2": "Wix → WordPress migrations, forms, basic SEO, hosting (e.g. o2switch)",
      "about.stack3": "Flutter Android apps — UI, business logic, APK delivery",
      "about.stack4": "Lightweight Tauri desktop / Windows exe for small business tools",
      "about.stack5": "HTML, CSS, JavaScript — this portfolio itself",
      "about.h2.zone": "Languages & area",
      "about.p4": "100% remote. Communication in French, English and Russian. Clients in France, the EU and Russian-speaking markets internationally — websites, apps and desktop software.",

      "contact.title": "Let's talk about your project",
      "contact.lead": "Tell me where you're at — I reply within 48 h.",
      "contact.filter": "WordPress sites, migrations, Android apps, Windows desktop software — describe your project.",
      ...
      "contact.trust": "Reply within 48 h · free quote · FR / EN / RU",
      "contact.success": "Message sent. I'll get back to you within 48 h.",
      "contact.fileWarning": "To send the form, open the site via GitHub Pages or a local server in Portfolio: python -m http.server 8080 then http://localhost:8080/contact.html",
      ...
      "mns.gallery.title": "A full product",
      ...
      "fe.p1": "Fruchart Équilibre is a <strong>weight-loss & naturopathy coach</strong> site: RAISON method, explainer video, articles, testimonials, pricing and an evaluation form. Everything started on <strong>Wix</strong> — we rebuilt on a clean base with our own code.",
      ...
      "fe.li1": "<strong>Content migration</strong> — faithful page-by-page copy from live Wix (full text)",
      ...
      "fe.p3": "Live on <strong>o2switch</strong> with SSL. Forms (evaluation and testimonials) send via <strong>contact@fruchartequilibre.com</strong> — host SMTP, messages received in production.",
      ...
      "hh.p2": "<strong>It works.</strong> All three hands run continuously (hours, minutes, seconds). The time shown is the machine's system clock — the user's exact local time, <strong>wherever they are</strong>, automatically.",
    ...
    ru: {
      ...
      "meta.about.desc": "Remote — WordPress, Flutter, миграции. FR / EN / RU. Франция, ЕС, международный рынок.",
      ...
      "meta.faq.title": "FAQ — Цифровой маяк",
      "meta.faq.desc": "Частые вопросы — remote, WordPress, Android, цены, сроки.",
      ...
      "common.faqLink": "FAQ",
      "common.faqTeaser": "Частые вопросы →",
      "common.discuss": "Обсудить проект",
      "common.backWorks": "← Работы",

      "index.hero.title": "Веб и мобильная разработка на расстоянии",
      "index.hero.lead": "WordPress на заказ, чистые миграции, Flutter, небольшие программы Windows — от брифа до продакшена, 100 % remote.",
      ...
      "index.sit.eyebrow": "Услуги",
      "index.sit.title": "Частые запросы",
      "index.sit.c1.title": "Миграция или редизайн",
      "index.sit.c1.desc": "Уйти с Wix или переделать сайт — чистый WordPress, перенос контента, продакшен.",
      "index.sit.c2.title": "WordPress на заказ",
      "index.sit.c2.desc": "Витрина, формы, доработки, продакшен (o2switch или другой хостинг).",
      "index.sit.c3.title": "Приложение Android",
      "index.sit.c3.desc": "Flutter-приложение под ключ — Android, поставка APK.",
      "index.sit.c4.title": "Небольшая программа Windows",
      "index.sit.c4.desc": "Простой desktop (часы, утилита). Чёткий scope, автономный результат.",
      "index.sit.cta": "Обсудить →",
      "index.homeCta.title": "Обсудим ваш проект",
      "index.homeCta.lead": "Опишите, где вы сейчас — ответ в течение 48 ч, бесплатная смета.",

      "faq.title": "Частые вопросы",
      "faq.lead": "Что чаще всего спрашивают перед стартом.",
      "faq.q1": "Как начинается работа?",
      "faq.a1": "Опишите проект в форме или по e-mail. Отвечу в течение 48 ч с уточняющими вопросами, затем смета или диапазон по объёму.",
      "faq.q2": "Вы работаете удалённо?",
      "faq.a2": "Да, 100 % remote. E-mail, видеозвонок при необходимости. Французский, английский и русский.",
      "faq.q3": "Берёте существующий сайт?",
      "faq.a3": "Да — миграция Wix → WordPress, правки, формы, продакшен (напр. o2switch). Адаптируюсь к существующему; полная переделка согласуется до старта.",
      "faq.q4": "Делаете IT-поддержку?",
      "faq.a4": "Нет. Разрабатываю сайты и приложения на заказ — не поддержку ПК, Word, Outlook или принтера.",
      "faq.q5": "Мобильные приложения: Android?",
      "faq.a5": "Android-приложения на Flutter — поставка APK, публикация в Play Store.",
      "faq.q6": "Сколько это стоит?",
      "faq.a6": "Зависит от объёма. Ориентировочные цены на российском рынке: разовое вмешательство от 12 000 ₽ (полдня), веб-проект (миграция Wix, WordPress, формы) от 20 000 ₽ / день — часто фиксированная сумма. Android-приложение или небольшой exe под Windows: по смете, от 25 000 ₽ / день. Бесплатная точная смета после обсуждения вашей задачи — объём согласован, понятная цена.",

      "works.title": "Работы",
      "works.lead": "Три кейса — миграция WordPress, Flutter-приложение, настольные часы Tauri.",
      ...
      "about.p2": "Я работаю с клиентами, которым нужен надёжный технический партнёр и работа на заказ.",
      "about.h2.path": "Опыт",
      "about.p3": "Обучение веб- и мобильной разработке, работаю под брендом Цифровой маяк. В портфолио: WordPress (мой сайт-витрина коуча), Android-приложение Flutter, небольшая настольная программа Windows. Код с версионированием, в продакшене; подробности в кейсах.",
      "about.h2.stack": "Стек и результаты",
      "about.stack1": "WordPress на заказ, Elementor, PHP (mu-plugins, SMTP, Schema.org)",
      "about.stack2": "Миграции Wix → WordPress, формы, базовое SEO, хостинг (напр. o2switch)",
      "about.stack3": "Android-приложения Flutter — интерфейс, логика, поставка APK",
      "about.stack4": "Desktop Tauri / exe Windows для небольших рабочих инструментов",
      "about.stack5": "HTML, CSS, JavaScript — этот portfolio",
      "about.h2.zone": "Языки и география",
      "about.p4": "100 % remote. Общение на французском, английском и русском. Клиенты во Франции, ЕС и русскоязычные на международном рынке — сайты, приложения и desktop.",

      "contact.title": "Обсудим ваш проект",
      "contact.lead": "Опишите, где вы сейчас — отвечу в течение 48 ч.",
      "contact.filter": "WordPress, миграции, Android-приложения, desktop под Windows — опишите ваш проект.",
      ...
      "contact.trust": "Ответ в течение 48 ч · бесплатная смета · FR / EN / RU",
      "contact.success": "Сообщение отправлено. Отвечу в течение 48 ч.",
      "contact.fileWarning": "Чтобы отправить форму, откройте сайт через GitHub Pages или локальный сервер в Portfolio: python -m http.server 8080, затем http://localhost:8080/contact.html",
      ...
      "contactSent.note": "Отвечаю с frucharthadrien@gmail.com — добавьте адрес в контакты при необходимости.",
      ...
      "mns.gallery.title": "Готовый продукт",
      ...
      "fe.p1": "Fruchart Équilibre — сайт <strong>коуча по похудению и натуропатии</strong>: метод RAISON, видео, статьи, отзывы, тарифы и форма оценки. Всё начиналось на <strong>Wix</strong> — чистая пересборка на нашей кодовой базе.",
      ...
      "fe.p3": "Сайт на <strong>o2switch</strong> с SSL. Формы (оценка и отзывы) через <strong>contact@fruchartequilibre.com</strong> — SMTP хостинга, письма приходят в продакшен.",
      ...
      "hh.p2": "<strong>Они работают.</strong> Три стрелки крутятся непрерывно (часы, минуты, секунды). Показывается системное время машины — точное локальное время пользователя, <strong>в любой стране</strong>, автоматически.",
